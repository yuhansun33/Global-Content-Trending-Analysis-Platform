...
def create_spark_session():
    builder = SparkSession.builder \
        .appName("NetflixTrendingAggregator") \
...
def run_streaming_aggregation():
    ...
    exploded_stream = parsed_stream \
        .withColumn("individual_genre", explode(split(col("genre"), ",")))
    ...
    trending_by_country = exploded_stream \
    ...
    # Format output
    output_stream = trending_by_country \
        .select(
